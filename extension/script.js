...
function afterDOMLoaded(){
	...
	jquery.integrity = "sha256-hVVnYaiADRTO2PzUGmuLJr8BLUSjGIZsDYGmIJLv2b8="
...
function renderSuggestions(parent, suggestions) {
	...
	var button =  replaceVariables(_TEMPLATES.hoverable, suggestions[0]);	
	// var leftContent = convertTemplateToDOM(_TEMPLATES.leftContent,{content : suggestion1})
	var content = convertTemplateToDOM(_TEMPLATES.leftContent,{content : button})
